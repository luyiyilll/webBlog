...
<script>
  ...
  export default {
    ...
    data() {
      return {
        description: 'Zero Blog 是基于Vue.js+SpringBoot搭建的博客网站',
        contacts: [
          {
            icon: 'envelope',
            title: '反馈问题',
          ...
          },
          {
            icon: 'weibo',
            title: '关注微博',
            link: 'https://weibo.com/u/3243345820?nick=%E5%8D%A2%E6%BC%AALuYi&is_all=1'
          },
          {
            icon: 'weixin',
            title: '加我微信',
        ...
        <span style="font-size:0.9em">Designed by
          ...
          <a href="https://github.com/summerblue"target="_blank"style="color:inherit">Sarah Lu</a>
        </span>
      `,
        sponsor: {
          title: '相关网站',
