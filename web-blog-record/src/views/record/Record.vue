	  ...
	  <div v-for="record,index in records" v-if="index<=limitCount" class="result">
		 <el-card class="box-card" style="width: 100%;" shadow="hover">
		   ...
		   <div slot="header" class="clearfix">
			 <div class="inline-block"><el-avatar :size="50" :src="record.avatar"></el-avatar></div>
			...
			<el-dropdown style="float: right; padding: 3px 0">
			     <i class="el-icon-more-outline"></i>
				   <el-dropdown-menu slot="dropdown">
				     <el-dropdown-item><div><i class="el-icon-share"></i>分享</div></el-dropdown-item>
				     <el-dropdown-item v-if="auth&user.username==record.uname"><div @click="deleteMyRecord(record.rid)"><i class="el-icon-delete"></i>删除</div></el-dropdown-item>
				   </el-dropdown-menu>
			</el-dropdown>
		   </div>
		   ...
		   <el-collapse v-if="auth&user.username==record.uname" v-model="activeNames" @change="handleChange">
		     <el-collapse-item title="编辑">
			   ...
			   <div id="edit-box" class="reply-box form box-block">
		         <textarea  v-model="content" style="width: 100%;" v-if="auth" ref="content" id="editor" placeholder="在此修改随笔..."></textarea>
		       </div>
		       <div class="form-group reply-post-submit">
		         <button id="edit-btn" :disabled="!auth" @click="commitedEdit(this.recid)" class="btn btn-primary">
		           保存编辑
		         </button>
		       </div>
